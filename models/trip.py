...
class Trip:
    def __init__(self, id, tourist_id, start_location, end_location, start_date, end_date, created_at=None):
        self.id = id
    ...
    def create(tourist_id, start_location, end_location, start_date, end_date):
        ...
        cursor = conn.cursor()
        cursor.execute("""
            INSERT INTO trip (tourist_id, start_location, end_location, start_date, end_date, created_at)
            VALUES (%s,%s,%s,%s,%s,%s)
